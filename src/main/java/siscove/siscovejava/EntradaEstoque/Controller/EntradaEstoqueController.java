...
public class EntradaEstoqueController extends BaseController {
	...
	public EnvelopeResponse<EntradaEstoqueDto> salvarEntradaEstoque(@RequestBody EntradaEstoqueDto entradaEstoqueDto) {
		EnvelopeResponse<EntradaEstoqueDto> retorno = entradaEstoqueService.salvar(entradaEstoqueDto);
		return retorno;
	}
